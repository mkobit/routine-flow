...
const commonKitFields = {
  schemaVersion: z.union([z.literal('2'), z.literal(2)]),
...
// --- Alternative/Build Step Kit Spec v2 ---

export const kitBuildStepSchema = z
  .object({
    name: z.string().optional(),
    command: z.string().min(1),
  })
...
export const kitBuildSpecV2Schema = z
  .object({
    schemaVersion: z.union([z.literal('2'), z.literal(2)]),
    name: z.string().regex(kitNameRegex),
    version: z.string().optional(),
    ...
    build: z
      .object({
        steps: z.array(kitBuildStepSchema).optional(),
      })
      .strict()
      .optional(),
    environment: environmentSchema.optional(),
...
export const kitSpecSchema = z.union([
  kitMixinSpecV2Schema,
  kitSandboxSpecV2Schema,
...
export const sbxEnvPortSchema = z
  .object({
    sandbox: z.number().int().min(1).max(65_535),
